namespace IGain
{
    ...
    public class CreditPage : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label5.Size = new Size(0xd0, 0x20);
            this.label5.TabIndex = 8;
            this.label5.Text = "Credit Issue Form :";
            ...
            this.BeginDate.Location = new Point(0x1f0, 0x60);
            ...
            base.Name = "CreditPage";
            base.ShowInTaskbar = false;
            base.StartPosition = FormStartPosition.CenterScreen;
            this.Text = "Issue Credit";
        ...
        private void PerformCreditIssueTrans()
        {
            ...
            try
            {
                ...
                string str17 = Convert.ToString(new OleDbCommand("Select CreditFlow.CreditID from  Transactions,CreditFlow,AccountTypes\twhere  Transactions.TransactionID=CreditFlow.TransactionID and CreditFlow.IsClosed=0 and  Transactions.AccountCredited=AccountTypes.AccountID and AccountTypes.AccountID in  (Select AccountID from AccountTypes where AccountType='Credit'and AccountSubType='" + this.Creditee.Text + "')", Con).ExecuteScalar());
                string str18 = "Update CreditFlow Set IsClosed=1 where CreditID='" + str17 + "'";
                string str19 = "UPDATE Transactions set Debit='0',Credit='0' where SequenceOfInterestApplication=0 and AccountDebited= '" + str6 + "'";
