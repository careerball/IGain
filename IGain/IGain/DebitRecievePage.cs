namespace IGain
{
    ...
    public class DebitRecievePage : Form
    {
        ...
        {
            ResourceManager manager = new ResourceManager(typeof(DebitRecievePage));
            ...
            this.label1.Size = new Size(0x60, 0x10);
            this.label1.TabIndex = 0;
            this.label1.Text = "Recieved from";
            ...
            this.label9.Location = new Point(0xa8, 0x48);
            ...
            this.CarriedForwardInterest.Location = new Point(0x130, 0x48);
            ...
            this.CarriedPrinciple.Location = new Point(0x188, 0x48);
            ...
            this.MoveCFI.Location = new Point(0x160, 0x68);
            ...
            this.MoveCFP.Location = new Point(0x188, 0x68);
        ...
        private void PerformCreditIssueTrans()
        {
            ...
            try
            {
                ...
                BusinessLogic.MyMessageBox("The credit of " + this.Principle.Text + @"\- from " + this.Creditee.Text + " is recieved!", "Credit Recieved!");
                base.Close();
            }
