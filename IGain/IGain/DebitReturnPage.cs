namespace IGain
{
    ...
    public class DebitReturnPage : Form
    {
        ...
        {
            ResourceManager manager = new ResourceManager(typeof(DebitReturnPage));
            ...
            this.label1.Location = new Point(8, 0x90);
            ...
            this.label2.Location = new Point(0xe0, 0x90);
            this.label2.Name = "label2";
            this.label2.Size = new Size(0x70, 0x18);
            this.label2.TabIndex = 2;
            this.label2.Text = "an amount of Rs.";
            this.Principle.Location = new Point(0x150, 0x90);
            ...
            this.label5.Text = "Credit Return Form :";
            ...
            this.label8.Location = new Point(0x1c0, 0x90);
            this.label8.Name = "label8";
            this.label8.Size = new Size(40, 0x18);
            this.label8.TabIndex = 0x2a;
            this.label8.Text = "as on";
            this.BeginDate.Location = new Point(0x1f0, 0x90);
            ...
            this.IssueCredit.Location = new Point(0x178, 0x1a8);
            ...
            this.Creditee.Location = new Point(0x68, 0x90);
            ...
            this.label9.Location = new Point(0x58, 0x48);
            ...
            this.CarriedForwardInterest.Location = new Point(0xd8, 0x48);
            ...
            this.CarriedPrinciple.Location = new Point(0x178, 0x48);
            this.CarriedPrinciple.Name = "CarriedPrinciple";
            this.CarriedPrinciple.Size = new Size(80, 20);
            ...
            this.label14.Location = new Point(0x1d8, 0x48);
            this.label14.Name = "label14";
            this.label14.Size = new Size(120, 0x10);
            this.label14.TabIndex = 0x2e;
            this.label14.Text = "- : Carried Principle";
            this.MoveCFI.Image = (Bitmap) manager.GetObject("MoveCFI.Image");
            this.MoveCFI.Location = new Point(0x138, 0x40);
            this.MoveCFI.Name = "MoveCFI";
            this.MoveCFI.Size = new Size(40, 0x20);
            this.MoveCFI.TabIndex = 0x2f;
            this.MoveCFI.Click += new EventHandler(this.MoveCFI_Click);
            this.MoveCFP.Image = (Bitmap) manager.GetObject("MoveCFP.Image");
            this.MoveCFP.Location = new Point(400, 0x60);
            ...
            base.ClientSize = new Size(0x2b0, 0x1e5);
            base.Controls.AddRange(new Control[] { 
                this.MoveCFP, this.MoveCFI, this.label14, this.CarriedPrinciple, this.CarriedForwardInterest, this.label9, this.Creditee, this.IssueCredit, this.BeginDate, this.label8, this.SlipNumber, this.IsSlipIssued, this.TermDuration3, this.label15, this.InterestType3, this.label16, 
                this.Per3, this.label17, this.Rate3, this.label18, this.TermDuration2, this.ThereAfter2, this.Term2, this.label10, this.InterestType2, this.label11, this.Per2, this.label12, this.Rate2, this.label13, this.TermDuration1, this.ThereAfter1, 
                this.Term1, this.label7, this.InterestType1, this.label6, this.Per1, this.label4, this.Rate1, this.label3, this.label5, this.Principle, this.label2, this.label1
             });
            base.MaximizeBox = false;
            base.Name = "DebitReturnPage";
        ...
        private void MoveCFI_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    this.CarriedPrinciple.Text = Convert.ToString((double) (Convert.ToDouble(this.CarriedPrinciple.Text) - Convert.ToDouble(this.MoveCFI.Tag)));
        ...
        private void MoveCFP_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    this.Principle.Text = Convert.ToString((double) (Convert.ToDouble(this.MoveCFP.Tag) - Convert.ToDouble(this.Principle.Text)));
        ...
        private void PerformCreditIssueTrans()
        {
            ...
            try
            {
                ...
                if (Convert.ToDouble(this.Principle.Text) < 0.0)
                {
                    CreditPage.Con = Con;
                    CreditPage page = new CreditPage();
                    try
                    {
                        page.CarriedForwardInterest.Text = Convert.ToString((double) (Convert.ToDouble(this.CarriedForwardInterest.Text) * -1.0));
                        page.Principle.Text = Convert.ToString((double) (Convert.ToDouble(this.Principle.Text) * -1.0));
                        page.Creditee.Items.Add(this.Creditee.Text);
                        page.BeginDate.Text = this.BeginDate.Text;
                        page.BeginDate.Enabled = false;
                        page.IsSlipIssued.Checked = this.IsSlipIssued.Checked;
                        page.SlipNumber.Enabled = this.SlipNumber.Enabled;
                        page.SlipNumber.Text = this.SlipNumber.Text;
                    }
                ...
                if (num == 0)
                {
                    ...
                    Exception exception2 = BusinessLogic.ModifyStoreHouse(Con, queryToRun, null);
                    if (exception2 != null)
                    {
                        throw exception2;
                    }
                ...
                BusinessLogic.MyMessageBox("The credit of " + this.Principle.Text + @"\- from " + this.Creditee.Text + " is approved!", "Credit Approved!");
                base.Close();
            }
            catch (Exception exception9)
            {
                exception = exception9;
                if (exception.Message != "Close")
                {
                    BusinessLogic.MyMessageBox(exception.Message);
                }
                else
